...
# dot-ai-migrate — Convention Version Migration
...
if [[ "$WORKSPACE_VERSION" != "$SKILL_VERSION" ]]; then
  echo "Migration needed: $WORKSPACE_VERSION → $SKILL_VERSION"
fi
```
...
# Show changelog
echo "Migrating: $OLD_VERSION → $NEW_VERSION"
...
**Success:**
```
🔄 Migrating .ai/ convention: 0.1.0 → 0.2.0

Backup created: .ai/backups/migration-20260206-1430/

Applying migration steps:
  ✅ Regenerated projects-index.md with markers
  ✅ Created new sub-skills directories
