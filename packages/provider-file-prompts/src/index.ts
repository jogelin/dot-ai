/**
 * File-based prompt template provider.
 * Scans .ai/prompts/ for markdown files with frontmatter.
 */
import { readdir, readFile } from 'node:fs/promises';
import { join, basename, extname } from 'node:path';
import type { PromptProvider, PromptTemplate } from '@dot-ai/core';
